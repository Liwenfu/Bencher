...
public class CustomHttpClient {
	 ...
	 * @return
	 */
	public static String PostFromWebByHttpClient(Context context, String url,//提交数据不带问号
	...
	public static String getFromWebByHttpClient(Context context, String url,//提交数据带？and &
